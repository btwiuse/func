//nolint: lll
//go:generate go run ../../tools/structdoc/main.go --file $GOFILE --struct IAMPolicyDocument --template ../../tools/structdoc/template.txt --data type=aws_iam_policy --output ../../docs/resources/aws/iam_policy_document.md
